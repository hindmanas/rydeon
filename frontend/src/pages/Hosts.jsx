...
function Hosts() {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans pb-20">
      ...
      {/* HERO SECTION */}
      <section className="relative overflow-hidden pt-12 pb-16 sm:pt-20 sm:pb-24 px-4 border-b border-slate-100 bg-gradient-to-b from-slate-950 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800 text-teal-400 text-xs font-extrabold uppercase tracking-wider">
          ...
          <div className="pt-4">
            <Link
              to="/signup"
              className="inline-flex items-center gap-2 rounded-xl bg-teal-500 hover:bg-teal-400 px-7 py-3.5 text-sm font-extrabold text-slate-950 shadow-lg shadow-teal-500/20 transition-all"
            >
      ...
      <section className="py-20 px-4 max-w-6xl mx-auto space-y-16">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <span className="text-xs font-bold text-teal-700 uppercase tracking-widest block">HOST WORKFLOW</span>
          <h2 className="text-3xl sm:text-4xl font-black text-slate-950">How offering a ride works</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="bg-slate-50 border border-slate-200/80 p-6 rounded-2xl space-y-3 relative hover:bg-white hover:shadow-md transition">
              <span className="w-10 h-10 rounded-xl bg-slate-950 text-teal-400 font-black flex items-center justify-center text-sm shadow">
                {item.step}
              </span>
              <h3 className="font-extrabold text-slate-950 text-base">{item.title}</h3>
        ...
        <div className="relative rounded-3xl overflow-hidden border border-slate-200 shadow-xl bg-slate-50 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center p-6 lg:p-8">
          <div className="lg:col-span-6 space-y-4">
            <span className="text-xs font-bold text-teal-700 uppercase tracking-widest block">AUTHENTIC STUDENT DRIVER</span>
            <h3 className="text-2xl font-black text-slate-950">Cover fuel costs without commercial taxi hassle</h3>
      ...
      <section className="py-16 px-4 bg-slate-50 border-t border-b border-slate-200/80">
        <div className="max-w-5xl mx-auto space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-xs font-bold text-teal-700 uppercase tracking-widest block">LIVE DASHBOARD MOCKUP</span>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl shadow-xl overflow-hidden max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-6 bg-slate-50 border-b border-slate-100 text-center text-xs">
              <div className="bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <span className="text-2xl font-black text-teal-700">2</span>
              </div>
              <div className="bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-full bg-slate-950 text-teal-400 font-black flex items-center justify-center text-sm shrink-0">
                    AP
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
      ...
      <section className="mt-16 text-center max-w-3xl mx-auto px-4 space-y-6">
        ...
        <div>
          <Link
            to="/signup"
            className="inline-flex items-center gap-2 rounded-xl bg-slate-950 hover:bg-slate-800 px-8 py-3.5 text-sm font-extrabold text-white shadow-md transition"
          >
