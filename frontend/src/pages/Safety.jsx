...
function Safety() {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans pb-20">
      ...
      {/* CORE SAFETY PILLARS WITH GENUINE PHOTOS */}
            ...
            {[
              {
                ...
                desc: "Choose well-lit, recognizable spots like PCU campus security gates, library plaza, or official transit stands."
              },
              {
                number: "02",
              ...
              },
              {
                ...
                desc: "If any user violates community standards, report them directly through teamrydeon@gmail.com immediately."
              },
              {
                number: "06",
